...
public class OwnershipTransferQueryBuilder {
	...
	private static final String SEARCH_QUERY = SELECT + "pt.*,address.*,ownership.*,od.*,doc.*,"
			...
			+ " od.relation_with_deceased_allottee, od.date_of_death_allottee, od.application_number, od.application_type,"
			+ " od.permanent, od.isapro_charge_paid, od.payment_amount,od.bank_name,od.transaction_number, "
