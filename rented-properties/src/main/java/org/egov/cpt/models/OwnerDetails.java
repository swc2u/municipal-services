...
public class OwnerDetails {
	...
	@Size(max = 256, message = "owned id must be between 0 and 256 characters in length")
	...
	@Size(max = 256, message = "applicatin number must be between 0 and 256 characters in length")
