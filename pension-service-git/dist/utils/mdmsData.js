            ...
            requestBody = {
              ...
              MdmsCriteria: {
                ...
                moduleDetails: [{
                  ...
                  moduleName: "pension",
                  masterDetails: [{ name: "DocumentType_RRP" }, { name: "DocumentType_DOE" }, { name: "DocumentType_DOP" }, { name: "EmployeeLeaveType" }, { name: "Disability" }, { name: "DAPercentage" }, { name: "IRPercentage" }, { name: "AdditionalPensionPercentage" }, { name: "BankDetails" }]
                }]
              }
            };
            _context.next = 4;
