...
exports.getAdditionalPensionPercentageForFamily = exports.isEldestDependent = exports.getYearDifference = exports.getAgeOnRetirementDate = exports.getAge = exports.getDOJ = exports.getPensionConfigurationValue = exports.getAdditionalPensionPercentageAfterRetirement = exports.getAdditionalPensionPercentage = exports.getIRPercentage = exports.getCommutationMultiplier = exports.getCommutationPercentage = exports.getDAPercentage = exports.lastDayOfMonth = exports.isDateLastDayOfMonth = exports.getMonthsDaysInRange = exports.getGQSDay = exports.getGQSMonth = exports.getGQSYear = exports.getGQS = exports.getNQS = exports.getNQSDay = exports.getNQSMonth = exports.getNQSYear = exports.getHalfYearOfService = exports.getYearOfService = undefined;
...
var getDAPercentage = exports.getDAPercentage = function getDAPercentage(effectiveDate, mdms) {
  var value = 0;
  var mdmsDAPercentage = (0, _get2.default)(mdms, "MdmsRes.pension.DAPercentage");
  //const mdmsDAPercentage=get(mdms,"DAPercentage");  
  var daPercentageList = (0, _filter2.default)(mdmsDAPercentage, function (x) {
    return (0, _gte2.default)(new Date(effectiveDate), new Date(x.startDate)) && (0, _lte2.default)(new Date(effectiveDate), new Date(x.endDate)) && x.endDate != null;
  });
  ...
  if (daPercentageList && daPercentageList.length > 0) {
    ...
    daPercentageList = (0, _filter2.default)(mdmsDAPercentage, function (x) {
      return (0, _gte2.default)(new Date(effectiveDate), new Date(x.startDate)) && x.endDate == null;
    });
...
var getIRPercentage = exports.getIRPercentage = function getIRPercentage(effectiveDate, mdms) {
  var value = 0;
  var mdmsIRPercentage = (0, _get2.default)(mdms, "MdmsRes.pension.IRPercentage");
  //const mdmsIRPercentage=get(mdms,"IRPercentage");  
  var irPercentageList = (0, _filter2.default)(mdmsIRPercentage, function (x) {
    return (0, _gte2.default)(new Date(effectiveDate), new Date(x.startDate)) && (0, _lte2.default)(new Date(effectiveDate), new Date(x.endDate)) && x.endDate != null;
  });
...
var getAdditionalPensionPercentageAfterRetirement = exports.getAdditionalPensionPercentageAfterRetirement = function getAdditionalPensionPercentageAfterRetirement(dateOfBirth, effectiveDate, mdms) {
  var value = 0;
  //let age=getAge(employee.dob);
  var age = Math.trunc(getYearDifference(dateOfBirth, effectiveDate));
  var mdmsAdditionalPensionPercentage = (0, _get2.default)(mdms, "MdmsRes.pension.AdditionalPensionPercentage");
  //const mdmsAdditionalPensionPercentage=get(mdms,"AdditionalPensionPercentage");
  var additionalPensionPercentageList = (0, _filter2.default)(mdmsAdditionalPensionPercentage, function (x) {
    return (0, _gte2.default)(age, x.fromAge) && (0, _lte2.default)(age, Number(x.toAge)) && x.toAge != null;
...
var getPensionConfigurationValue = exports.getPensionConfigurationValue = function getPensionConfigurationValue(key, mdms) {
  ...
  var mdmsConfigurations = (0, _get2.default)(mdms, "MdmsRes.pension.configurations");
...
var getYearDifference = exports.getYearDifference = function getYearDifference(dtPreviousDate, dtNextDate) {
  var age = 0;

  var pMonths = dtPreviousDate.getFullYear() * 12 + dtPreviousDate.getMonth() - 1;
  var nMonths = dtNextDate.getFullYear() * 12 + dtNextDate.getMonth() - 1;

  var diffYear = (nMonths - pMonths) / 12;
