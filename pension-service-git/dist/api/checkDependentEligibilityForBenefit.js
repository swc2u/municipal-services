...
exports.default = function (_ref) {
  ...
  api.post("/_checkDependentEligibilityForBenefit", asyncHandler(function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return (0, _utils.getDependentEligibilityForBenefit)(body);

            case 3:
              eligibilityRespone = _context.sent;


              _logger2.default.debug("eligibilityRespone", JSON.stringify(eligibilityRespone));
...
//# sourceMappingURL=checkDependentEligibilityForBenefit.js.map