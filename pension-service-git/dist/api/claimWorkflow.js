...
exports.default = function (_ref) {
  ...
  api.post("/_claimWorkflow", asyncHandler(function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              payloads = [];
              _context.next = 3;
              return (0, _create.addUUIDAndAuditDetailsClaimReleaseWorkflow)(body);

            case 3:
              body = _context.sent;

              _logger2.default.debug("body", body);
              topic = _envVariables2.default.KAFKA_TOPICS_CLAIM_WORKFLOW;
...
//# sourceMappingURL=claimWorkflow.js.map