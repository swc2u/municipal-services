...
//	@NotNull
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, purchaseOrder.id) && Objects.equals(this.tenantId, purchaseOrder.tenantId)
	...
	public int hashCode() {
		return Objects.hash(id, tenantId, store, purchaseOrderNumber, purchaseOrderDate, purchaseType, rateType,
				supplier, advanceAmount, totalAdvancePaidAmount, advancePercentage, expectedDeliveryDate, deliveryTerms,
				paymentTerms, remarks, status, workFlowDetails, stateId, purchaseOrderDetails, fileStoreId, designation,
