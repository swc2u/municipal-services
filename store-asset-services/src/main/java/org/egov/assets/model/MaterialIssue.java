...
/**
 * This object holds information for Indent Issue, Non Indent Issue and Transfer
 * Outward Note.
 */
...
public class MaterialIssue {
	...
	/**
	 * Applicable in case of None Indent Issue. This field holds information about
	 * Issuing purpose of the Non Indent Issue
	 */
	...
	/**
	 * If material issue used in srap process then enable this flag. This will help
	 * in recreation of scrap notes using issue details. By default value is false.
	 * 
	 * @return scrapCreated
	 **/
	...
	/**
	 * Applicable for Indent Issue. This object holds the indent information for
	 * which the material is being issued. There could be multiple issues against an
	 * indent.
	 * 
	 * @return indent
	 **/
	...
	/**
	 * Applicable for Indent Issue and Transfer Outward Issue. Indent/Transfer
	 * Issued To Employee.
	 * 
	...
	/**
	 * Applicable for Indent Issue. Designation of the employee to whom the indent
	 * is issued.
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, materialIssue.id) && Objects.equals(this.tenantId, materialIssue.tenantId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, issueType, fromStore, toStore, issueNumber, scrapCreated, issueDate,
				materialIssueStatus, description, totalIssueValue, fileStoreId, designation, indent, issuedToEmployee,
				issuedToDesignation, issuePurpose, supplier, materialIssueDetails, workFlowDetails, stateId,
				auditDetails);
	}
