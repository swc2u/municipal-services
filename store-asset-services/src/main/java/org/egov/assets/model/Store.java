...
public class Store {
	...
	/**
	 * Whether Store is Active or not. If the value is TRUE, then Store is active,If
	 * the value is FALSE then Store is inactive,Default value is TRUE
	 *
	 * @return active
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, store.id) && Objects.equals(this.tenantId, store.tenantId)
				...
				&& Objects.equals(this.contactNo2, store.contactNo2) && Objects.equals(this.email, store.email)
				&& Objects.equals(this.storeInCharge, store.storeInCharge)
				&& Objects.equals(this.isCentralStore, store.isCentralStore)
				&& Objects.equals(this.active, store.active) && Objects.equals(this.auditDetails, store.auditDetails);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, code, name, description, department, officeLocation, billingAddress,
				deliveryAddress, contactNo1, contactNo2, email, storeInCharge, isCentralStore, active, auditDetails);
	}
