...
/**
 * Hold the material receipt note material level information. This will show
 * which material is received based on which purchase order.
 */
...
public class MaterialReceiptDetail {
	...
	/**
	 * The quantity of the material received for this particular purchase order or
	...
	/**
	 * The quantity of the material received for this particular purchase order or
	 * inter store transfer in the based UOM.
	 * 
	 * @return receivedQty
	 **/
	...
	/**
	 * The quantity of the material accepted from the total quantity of materials
	 * received. This field also contains Opening Quantity when the receipt purpose
	 * is OPENING BALANCE.
	 * 
	...
	/**
	 * The quantity of the material accepted from the total quantity of materials
	 * received in Base UOM. Accepted quantity cannot be greater than the received
	 * quantity. This field also contains Opening Quantity when the receipt purpose
	 * is OPENING BALANCE.
	 * 
	 * @return acceptedQty
	 **/
	...
	/**
	 * asset code if asset received. Create asset in asset module and save the
	 * reference.
	 * 
	 * @return asset
	 **/
	...
	/**
	 * is scrap item flag. Donot use this data to issue material and show in any
	 * stock ledger report.
	 * 
	 * @return isScrapItem
	 **/
	...
	public MaterialReceiptDetail addReceiptDetailsAddnInfoItem(
			MaterialReceiptDetailAddnlinfo receiptDetailsAddnInfoItem) {
