...
/**
 * This object holds the materail issue and receipts used for material issue.
 * This table will be used in FIFO logic and total items issued againest a
 * particular receipt.
 */
...
public class MaterialIssuedFromReceipt {
	...
	/**
	 * In case of return of material purpose type, select initial receipt to keep
	 * account. Do not use fifo logic in case of return to supplier. Supplier will
	 * received the same goods which are identified by lot number, expiry date,
	 * serial number or manufacture number or receive date wise. For other purpose
	 * use FIFO logic to issue item.
	 * 
	...
	/**
	 * if material has lot number, expiry date, serial number or manufacture number
	 * then save receipt additional info id also.
	 * 
	...
	/**
	 * If material issue cancelled or rejected in workflow, then use status as
	 * false.
	 * 
	 * @return status
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, materialIssuedFromReceipt.id)
				...
				&& Objects.equals(this.materialReceiptDetailAddnlinfoId,
						materialIssuedFromReceipt.materialReceiptDetailAddnlinfoId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, tenantId, materialReceiptId, materialReceiptDetail, materialReceiptDetailAddnlinfoId,
				quantity, status, auditDetails);
	}
	...
	public String toString() {
		...
		sb.append("    materialReceiptDetailAddnlinfoId: ").append(toIndentedString(materialReceiptDetailAddnlinfoId))
				.append("\n");
