...
public class HCQueryBuilder {
	...
	private static final String QUERY = "select service_request_id,service_type,owner_name,service_request_status,current_assignee,to_char(to_timestamp(cast(createdtime/1000 as bigint))::date ,'DD/MM/YYYY')as createdtime,lastmodifiedtime from eg_hc_service_request hc ";
