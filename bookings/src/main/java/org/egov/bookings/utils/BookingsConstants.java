...
public class BookingsConstants {
	...
	public static final int TEN_MINUTES = 30;
	
	public static final String BUSINESS_SERVICE_OSBM_PAYMENT = "BOOKING_BRANCH_SERVICES.MANUAL_OPEN_SPACE";
	
	public static final String BUSINESS_SERVICE_PACC_PAYMENT = "BOOKING_BRANCH_SERVICES.COMMUNITY_CENTRES_JHANJ_GHAR";
	
	public static final String BUSINESS_SERVICE_WT_PAYMENT = "BOOKING_BRANCH_SERVICES.WATER_TANKAR_CHARGES";
	
	public static final String BUSINESS_SERVICE_CGB_PAYMENT = "BOOKING_BRANCH_SERVICES.BOOKING_COMMERCIAL_GROUND";
	
	public static final String BUSINESS_SERVICE_OPEN_SPACE_PAYMENT = "BOOKING_BRANCH_SERVICES.BOOKING_GROUND_OPEN_SPACES";
